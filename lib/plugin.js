...
import {
  ...
  currentSessionCycle,
  sessionCycleCount,
  sessionEndTime, moraleValues, energyValues, completionValues, runningCriticalCode, status
...
//import {endTime} from "./ampletime/date-time.js"
...
import {_promptInput, _promptCustomizeSettingBySession} from "./amplefocus/prompts.js";
  ...
  insertText: {
    "Focus": async function(app, handlePastCycles = false) {
      try {
        ...
        // ADD CODE TO CUSTOMIZE SETTINGS
    ...
    "Edit Settings": async function (app) {
      try {
        ...
        // ADD CODE TO EDIT DEFAULT SETTINGS
